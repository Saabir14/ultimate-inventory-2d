...
void initialize_gdextension_types(ModuleInitializationLevel p_level) {
	...
	// Nodes
	GDREGISTER_CLASS(SlotUI)
	GDREGISTER_CLASS(ItemUI)
...
extern "C" {
// Initialization
GDExtensionBool GDE_EXPORT ultimate_inventory_2d_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
